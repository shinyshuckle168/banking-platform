...
// import com.group1.banking.security.OwnershipService;
...
//     private final OwnershipService ownershipValidator;
...
//                                    OwnershipService ownershipValidator,
...
//         Instant periodStart = Instant.from(yearMonth.atDay(1).atStartOfDay());
...
//                         accountId, periodStart, Instant.from(periodEnd));
