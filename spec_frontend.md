...
**Backend Dependencies:** login-api and account-service  
...
- login and customer profile endpoints from `login-api`
- banking account and money-movement endpoints from `account-service`
...
- A separate dedicated transaction-history microservice UI
- Native mobile clients
- Rich internal-admin analytics features unrelated to the documented endpoints
- Any backend capabilities not documented in the current login/customer spec or `account-service/specs/spec.md`
...
The frontend must integrate with both backend services.

| Service | Method | Endpoint | Frontend Use |
|---|---|---|---|
| Identity/Customer | `POST` | `/api/auth/register` | Registration submit |
| Identity/Customer | `POST` | `/api/auth/login` | Login submit |
| Identity/Customer | `POST` | `/api/auth/password-reset` | Password reset request |
| Identity/Customer | `POST` | `/api/auth/refresh` | Token refresh |
| Identity/Customer | `POST` | `/api/customers` | Create customer profile |
| Identity/Customer | `PATCH` | `/api/customers/{customerId}` | Update customer profile |
| Identity/Customer | `GET` | `/api/customers/{customerId}` | Get customer details |
| Account Service | `DELETE` | `/customers/{customerId}` | Admin delete customer |
| Account Service | `POST` | `/customers/{customerId}/accounts` | Create account |
| Account Service | `GET` | `/accounts/{accountId}` | Get account details |
| Account Service | `GET` | `/customers/{customerId}/accounts` | List customer accounts |
| Account Service | `PUT` | `/accounts/{accountId}` | Update account |
| Account Service | `DELETE` | `/accounts/{accountId}` | Admin delete account |
| Account Service | `POST` | `/accounts/{accountId}/deposit` | Deposit funds |
| Account Service | `POST` | `/accounts/{accountId}/withdraw` | Withdraw funds |
| Account Service | `POST` | `/accounts/transfer` | Transfer funds |
...
- The frontend must support different base URLs per service.
...
- Registration, login, customer create, customer get, and customer update work against `login-api`.
- Account create, retrieve, list, update, delete, deposit, withdraw, and transfer flows work against `account-service`.
